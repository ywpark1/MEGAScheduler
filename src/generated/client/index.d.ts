...
export namespace Prisma {
  ...
  */
  ...
  export type ReportUserGetPayload<
    ...
    ? ReportUser  & {
    [P in TrueKeys<S['include']>]:
        P extends 'Report' ? ReportGetPayload<S['include'][P]> | null :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Report' ? ReportGetPayload<S['select'][P]> | null :  P extends keyof ReportUser ? ReportUser[P] : never
  } 
    : ReportUser
  : ReportUser
